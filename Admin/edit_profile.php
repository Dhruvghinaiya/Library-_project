...
<body>
  ...
  <div class="col-5">
    ...
    <div class=" form-group view_profile_form">
      ...
      <input type="text" class="form-control" id="name"  value="<?php echo $password; ?>" name="password" >
    </div>
...
$query="UPDATE admin SET name='$_POST[name]',email='$_POST[email]',password='$_POST[password]',mobile='$_POST[mobile]' WHERE email='$_SESSION[email]' ";
$query_run=mysqli_query($con,$query);
