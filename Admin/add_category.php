  ...
  <nav class="navbar navbar-expand-lg navbar-light admin_navbar">
    <div class="container-fluid">
      <ul class="nav navbar-nav navbar-center">
        ...
        <li class="nav-item">
          <a href="admin/issue_book.php" class="nav-link">Issue Book</a>
        </li>
  ...
  <br><br>
    ...
    <div class="col-md-4">
        <form action="" method="POST" class="add_book">
          <h3 class="text-info">Add New Category</h3>
...
if(isset($_POST['add_cat'])){
  ...
  $query="insert into category values('','$_POST[cat_name]')";
    ...
    echo "<script> alert('category add sucessfully.. ') </script>";
  echo "<script> window.location.href = 'add_category.php';
  </script>"; 
}
