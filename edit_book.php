  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
    <div class="container-fluid">
      <div class="navbar-header ">
        <a class="navbar-brand " href="manage_book.php">SilverSmart Library</a>
      </div>
...
<?php
    if(isset($_POST['update'])){
        ...
        echo "<script> alert('book update sucessfully.. ') </script>";
        echo "<script> window.location.href = 'manage_book.php';
        </script>"; 
    }
?>