    ...
    <form action="" method="POST" class="add_book">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" name="book_author" id="author" class="form-control" required="">

        </div>
        <div class="form-group">
          <label for="cat">Category ID:</label>
          <input type="text" name="book_cat" id="cat" class="form-control" required="">

        </div>
        <div class="form-group">
          <label for="no">Book No:</label>
          <input type="text" name="book_no" id="no" class="form-control" required="">

          <div class="form-group">
            <label for="book">Book Price:</label>
            <input type="text" name="book_price" id="book" class="form-control" required="">
          </div>
...
if (isset($_POST['add_book'])) {
  ...
  echo "<script> alert('book add sucessfully.. ') </script>";
  echo "<script> window.location.href = 'add_book.php';
  </script>"; 
}
?>