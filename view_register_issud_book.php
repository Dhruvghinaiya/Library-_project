...
$query="select issued_book.s_no,issued_book.book_name,issued_book.book_author,issued_book.book_no,issued_book.student_id,users.name from issued_book left join users on issued_book.student_id=users.id ";
...
<body>
  ...
  <div class="col-md-8">
        <form action="">
            <table class="table-bordered table_issued">
