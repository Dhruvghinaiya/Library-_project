        ...
        <table class="table table-bordered table-hover" align="center">
            ...
            <?php
                    ...
                    while($row=mysqli_fetch_assoc($query_run)){
                        ...
                        <td><button class="btn" name=""><a href="edit_category.php?cid=<?php echo $row['cat_id'];?>">Edit</a></button>
                        <button class="btn" name=""><a href="delete_category.php?cid=<?php echo $row['cat_id']?>">Delete</a></button></td>
                        </tr>
                       <?php 
                    }
            ?>
