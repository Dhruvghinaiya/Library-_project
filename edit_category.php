  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
    <div class="container-fluid">
      <div class="navbar-header ">
        <a class="navbar-brand  " href="manage_category.php">SilverSmart Library</a>
      </div>
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
                ...
                <input type="text" name="cat_name" value="<?php echo
                 $cat_name;?>" id="name"  class="form-control" required="">
            </div>
...
<?php
    if(isset($_POST['update'])){
        ...
        echo "<script> alert('category update sucessfully.. ') </script>";
        echo "<script> window.location.href = 'manage_category.php';
        </script>"; 
    }
?>