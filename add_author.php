...
<body>
  ...
  <div class="col-md-4">
    <form action="" method="POST" class="add_book">
      <h3 class="text-info">Add New Author</h3>
      <div class="form-group">
        <label for="name">Author Name:</label>
        <input type="text" name="author_name" id="name" class="form-control" required="">
        <br>
...
if (isset($_POST['add_author'])) {
  ...
  echo "<script> alert('author add sucessfully.. ') </script>";
  echo "<script> window.location.href = 'add_author.php';
  </script>"; 
}
